...
class Listmatch90ItemWidget extends StatelessWidget {
  Listmatch90ItemWidget(this.listmatch90ItemModelObj);

  Listmatch90ItemModel listmatch90ItemModelObj;

  var controller = Get.find<Resultadosml3Controller>();
