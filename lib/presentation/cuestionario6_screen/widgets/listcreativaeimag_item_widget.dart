...
class ListcreativaeimagItemWidget extends StatelessWidget {
  ListcreativaeimagItemWidget(this.listcreativaeimagItemModelObj,
      {this.onTapColumncreativaeimag});

  ListcreativaeimagItemModel listcreativaeimagItemModelObj;

  var controller = Get.find<Cuestionario6Controller>();
