...
class Listmatch89ItemWidget extends StatelessWidget {
  Listmatch89ItemWidget(this.listmatch89ItemModelObj,
      {this.onTapColumnmatch89});

  Listmatch89ItemModel listmatch89ItemModelObj;

  var controller = Get.find<Resultadosml1Controller>();
