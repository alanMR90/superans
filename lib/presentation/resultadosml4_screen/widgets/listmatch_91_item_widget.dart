...
class Listmatch91ItemWidget extends StatelessWidget {
  Listmatch91ItemWidget(this.listmatch91ItemModelObj);

  Listmatch91ItemModel listmatch91ItemModelObj;

  var controller = Get.find<Resultadosml4Controller>();
