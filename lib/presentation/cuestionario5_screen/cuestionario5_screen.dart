import '../cuestionario5_screen/widgets/listanalticaymat1_item_widget.dart';
...
class Cuestionario5Screen extends GetWidget<Cuestionario5Controller> {
  @override
                                                ...
                                                child: Obx(() =>
                                                    ListView.builder(
                                                        ...
                                                        itemCount: controller
                                                            .cuestionario5ModelObj
                                                            .value
                                                            .listanalticaymat1ItemList
                                                            .length,
                                                        itemBuilder:
                                                            (context, index) {
                                                          Listanalticaymat1ItemModel
                                                              model = controller
                                                                  .cuestionario5ModelObj
                                                                  .value
                                                                  .listanalticaymat1ItemList[index];
                                                          return Listanalticaymat1ItemWidget(
                                                              model,
