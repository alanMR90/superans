...
class IniciarsesionScreen extends GetWidget<IniciarsesionController> {
  @override
                                  ...
                                  child: Container(
                                      ...
                                      child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                              ...
                                              prefixIcon: Container(margin: EdgeInsets.only(left: getHorizontalSize(14.00), top: getVerticalSize(15.50), right: getHorizontalSize(12.00), bottom: getVerticalSize(14.50)), child: Container(height: getSize(13.00), width: getSize(16.00), child: SvgPicture.asset(ImageConstant.imgVector41, fit: BoxFit.fill))),
                                  ...
                                  child: Container(
                                      ...
                                      child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                              ...
                                              disabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(getHorizontalSize(4.00)), borderSide: BorderSide(color: Colors.transparent)),
                                              border: OutlineInputBorder(borderRadius: BorderRadius.circular(getHorizontalSize(4.00)), borderSide: BorderSide.none),
                                              prefixIcon: Container(margin: EdgeInsets.only(left: getHorizontalSize(16.00), top: getVerticalSize(13.50), right: getHorizontalSize(14.00), bottom: getVerticalSize(14.50)), child: Container(height: getSize(15.00), width: getSize(12.00), child: SvgPicture.asset(ImageConstant.imgVector42, fit: BoxFit.fill))),
                                              prefixIconConstraints: BoxConstraints(minWidth: getSize(15.00), minHeight: getSize(15.00)),
                                              suffixIcon: Container(margin: EdgeInsets.only(left: getHorizontalSize(30.00), top: getVerticalSize(13.50), right: getHorizontalSize(14.00), bottom: getVerticalSize(13.50)), child: Container(height: getSize(16.00), width: getSize(16.00), child: SvgPicture.asset(ImageConstant.imgVector43, fit: BoxFit.fill))),
