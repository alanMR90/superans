import '../cuestionario4_screen/widgets/listcreativaeimag2_item_widget.dart';
...
class Cuestionario4Screen extends GetWidget<Cuestionario4Controller> {
  @override
                                                ...
                                                child: Obx(() =>
                                                    ListView.builder(
                                                        ...
                                                        itemCount: controller
                                                            .cuestionario4ModelObj
                                                            .value
                                                            .listcreativaeimag2ItemList
                                                            .length,
                                                        itemBuilder:
                                                            (context, index) {
                                                          Listcreativaeimag2ItemModel
                                                              model = controller
                                                                  .cuestionario4ModelObj
                                                                  .value
                                                                  .listcreativaeimag2ItemList[index];
                                                          return Listcreativaeimag2ItemWidget(
                                                              model,
