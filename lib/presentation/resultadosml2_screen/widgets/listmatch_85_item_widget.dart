...
class Listmatch85ItemWidget extends StatelessWidget {
  Listmatch85ItemWidget(this.listmatch85ItemModelObj,
      {this.onTapColumnmatch85});

  Listmatch85ItemModel listmatch85ItemModelObj;

  var controller = Get.find<Resultadosml2Controller>();

  VoidCallback? onTapColumnmatch85;
