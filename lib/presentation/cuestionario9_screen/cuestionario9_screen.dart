import '../cuestionario9_screen/widgets/listcreativaeimag1_item_widget.dart';
...
class Cuestionario9Screen extends GetWidget<Cuestionario9Controller> {
  @override
                                                ...
                                                child: Obx(() =>
                                                    ListView.builder(
                                                        ...
                                                        itemCount: controller
                                                            .cuestionario9ModelObj
                                                            .value
                                                            .listcreativaeimag1ItemList
                                                            .length,
                                                        itemBuilder:
                                                            (context, index) {
                                                          Listcreativaeimag1ItemModel
                                                              model = controller
                                                                  .cuestionario9ModelObj
                                                                  .value
                                                                  .listcreativaeimag1ItemList[index];
                                                          return Listcreativaeimag1ItemWidget(
                                                              model);
                                                        })))),
                                        Align(
                                            alignment: Alignment.centerRight,
